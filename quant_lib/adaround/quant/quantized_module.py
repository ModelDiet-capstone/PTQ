...
FakeQuantizeDict = {
    'FixedFakeQuantize':     FixedFakeQuantize,                                    # noqa: E241                                  # noqa: E241
...
def ActivationQuantizer(a_qconfig):
    # Debugging ===========================
    """print(f"DEBUG: Available Observers: {list(ObserverDict.keys())}")
    print(f"DEBUG: You requested: '{a_qconfig.observer}'")"""
    # =====================================
...
def WeightQuantizer(w_qconfig):
    # Debugging ===========================
    """print(f"DEBUG: Available Quantizers: {list(FakeQuantizeDict.keys())}")
    print(f"DEBUG: You requested: '{w_qconfig.quantizer}'")"""
    # =====================================
