...
from quant_lib.qdrop.quantization.quantized_module import QuantizedLayer, QuantizedBlock, Quantizer   # noqa: F401
...
# Note: torchvision models are NOT added to specials because their internal
# structure (attribute names like 'relu' vs 'relu1'/'relu2') differs from
# QDrop's model definitions. For torchvision models, layer-by-layer reconstruction
# is used instead of block-level reconstruction.
